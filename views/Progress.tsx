    ...
    <div className="space-y-8 animate-fade-slide">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white dark:bg-slate-800 p-8 rounded-[2.5rem] border border-neutral-200 dark:border-slate-700 shadow-sm flex flex-col items-center text-center">
          <div className="w-24 h-24 rounded-full border-8 border-sky-100 dark:border-sky-900/50 flex items-center justify-center text-3xl font-bold text-sky-500 mb-4">
            {avgGrade}
          </div>
          <h3 className="text-xl font-bold text-slate-900 dark:text-white">Rata-rata Nilai</h3>
        ...
        <div className="bg-white dark:bg-slate-800 p-8 rounded-[2.5rem] border border-neutral-200 dark:border-slate-700 shadow-sm md:col-span-2">
           <h3 className="text-xl font-bold mb-6 text-slate-900 dark:text-white">Analisis Ketuntasan Tugas</h3>
              ...
              <div className="flex-1 space-y-4">
                 <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm font-bold text-slate-500 dark:text-slate-400 uppercase">Tugas Selesai</span>
                    </div>
                 ...
                 <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm font-bold text-slate-500 dark:text-slate-400 uppercase">Tugas Belum Selesai</span>
                    </div>
                    <span className="font-bold text-slate-900 dark:text-white">{missingCount > 0 ? missingCount : 0}</span>
                 </div>
      ...
      <div className="bg-white dark:bg-slate-800 p-8 rounded-[2.5rem] border border-neutral-200 dark:border-slate-700 shadow-sm">
        <h3 className="text-2xl font-bold mb-8 text-slate-900 dark:text-white">Tren Performa Belajar</h3>
      ...
      <div className="bg-white dark:bg-slate-800 p-8 rounded-[2.5rem] border border-neutral-200 dark:border-slate-700 shadow-sm">
        <h3 className="text-xl font-bold mb-6 text-slate-900 dark:text-white">Detail Nilai per Mata Pelajaran</h3>
               ...
               <div key={course.id} className="p-5 rounded-2xl bg-slate-50 dark:bg-slate-700/50 flex items-center justify-between group hover:bg-white dark:hover:bg-slate-700 hover:shadow-md transition-all border border-transparent hover:border-slate-100 dark:hover:border-slate-600">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-400 dark:text-slate-500 font-bold uppercase">{course.code}</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-8">
                     <div className="text-right">
                       <p className="text-xs text-slate-400 dark:text-slate-500 font-bold uppercase mb-1">Status</p>
                       <p className="text-xs font-bold text-emerald-500 bg-emerald-50 dark:bg-emerald-900/30 px-2 py-1 rounded-lg">TUNTAS</p>
                     </div>
                     <div className="text-right">
                       <p className="text-xs text-slate-400 dark:text-slate-500 font-bold uppercase mb-1">Nilai Akhir</p>
                       <p className="text-xl font-bold text-slate-800 dark:text-white">{courseAvg}</p>
                     </div>
                  </div>
               </div>
             );
